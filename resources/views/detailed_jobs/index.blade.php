...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Detailed Jobs</h4>
            </div>
        ...
        @if(count($detailedJobs) == 0)
            <div class="panel-body text-center">
                <h4>No Detailed Jobs Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($detailedJobs as $detailedJob)
                        <tr>
                            <td>{{ $detailedJob->op_title }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('detailed_jobs.detailed_job.show', $detailedJob->id ) }}" class="btn btn-info" title="Show Detailed Job">
